...
public class PermissionsUtil {
    ...
    static String callPhonePermInfoMsg = "App needs this permission to access your phone dialer. Are you sure you want to deny this permission ?";
    static String callPhonePermErrorMsg = "Call permission denied. You can enable permission from settings";
        ...
        if (grantResults.length > 0
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, permission)) {
                ...
                if (permission.equals(STORAGE))
                    ...
                    alertBuilder.setMessage(contactsPermInfoMsg);
                else if (permission.equals(CALL_PHONE))
                    alertBuilder.setMessage(callPhonePermInfoMsg);
                ...
                if (permission.equals(STORAGE))
                    ...
                    Toast.makeText(context, callPhonePermErrorMsg, Toast.LENGTH_LONG).show();
                permissionListener.onPermissionResult(false);
            }
